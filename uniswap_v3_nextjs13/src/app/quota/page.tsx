...
const QuotaHome = () => {
    ...
    return (
        <div className='flex justify-center items-center w-full h-screen'>
            <button className='px-2 py-1 rounded-md bg-zinc-400 active:bg-zinc-300 mx-2' onClick={computeQuote}>compute quote</button> <span>{value}</span>
        </div>
    )
}

export default QuotaHome