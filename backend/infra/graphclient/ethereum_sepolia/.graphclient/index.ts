...
const documentHashMap = {
        "448b1c2697868fd7ac883a00bf4977c7f46108e3c605e68e52bc3f420230836b": GetMultipleEthereumSepoliaPoolLiveDataDocument
      }
additionalEnvelopPlugins.push(usePersistedOperations({
  ...
  return {
    ...
    get documents() {
      return [
      {
        document: GetMultipleEthereumSepoliaPoolLiveDataDocument,
        get rawSDL() {
          return printWithCache(GetMultipleEthereumSepoliaPoolLiveDataDocument);
        },
        location: 'GetMultipleEthereumSepoliaPoolLiveDataDocument.graphql',
        sha256Hash: '448b1c2697868fd7ac883a00bf4977c7f46108e3c605e68e52bc3f420230836b'
      }
    ];
    },
    fetchFn,
...
export type GetMultipleEthereumSepoliaPoolLiveDataQueryVariables = Exact<{
  poolIds: Array<Scalars['Bytes']['input']> | Scalars['Bytes']['input'];
}>;


export type GetMultipleEthereumSepoliaPoolLiveDataQuery = { uniswapv3_ethereum_sepolia: Array<Pick<Pool, 'liquidity' | 'tick' | 'sqrtPrice' | 'feeTier' | 'id'>> };
...
export const GetMultipleEthereumSepoliaPoolLiveDataDocument = gql`
    query GetMultipleEthereumSepoliaPoolLiveData($poolIds: [Bytes!]!) @live(interval: 5000) {
  uniswapv3_ethereum_sepolia: pools(where: {id_in: $poolIds}) {
    ...PoolLiveDataFields
  }
}
    ${PoolLiveDataFieldsFragmentDoc}` as unknown as DocumentNode<GetMultipleEthereumSepoliaPoolLiveDataQuery, GetMultipleEthereumSepoliaPoolLiveDataQueryVariables>;


export type Requester<C = {}, E = unknown> = <R, V>(doc: DocumentNode, vars?: V, options?: C) => Promise<R> | AsyncIterable<R>
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    GetMultipleEthereumSepoliaPoolLiveData(variables: GetMultipleEthereumSepoliaPoolLiveDataQueryVariables, options?: C): AsyncIterable<GetMultipleEthereumSepoliaPoolLiveDataQuery> {
      return requester<GetMultipleEthereumSepoliaPoolLiveDataQuery, GetMultipleEthereumSepoliaPoolLiveDataQueryVariables>(GetMultipleEthereumSepoliaPoolLiveDataDocument, variables, options) as AsyncIterable<GetMultipleEthereumSepoliaPoolLiveDataQuery>;
    }
  };
}
