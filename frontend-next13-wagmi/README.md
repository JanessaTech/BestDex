...
For the approval, please click **Confirm**. After that, a simuation is executed for the safety of the swapping.

![First approval](./demo/swap_4.jpg)

If the simulation is passed, it will start the process of swapping. Click **Confirm** to make the swapping finish.
...
Once the new position is added successfully, it goes to the page showing you how much tokens are deposited.
