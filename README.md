...
|**Stage2**|TBD|Introduce chain abstract to support the easy expansion to new chain| TBD| TDB|
|**Stage3**|TBD|Build a self-developed data indexing data pipeline to handle chain reorganization.| TBD| TDB|
